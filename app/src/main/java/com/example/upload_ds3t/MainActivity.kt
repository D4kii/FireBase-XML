...
//        //Uplaod V1 - FIM
        ...
        imageUri?.let {
            storeRef.putFile(it).addOnCompleteListener { task->
                ...
                if (task.isSuccessful) {
                    ...
                    storeRef.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        firebaseFirestore.collection("images").add(map).addOnCompleteListener { firestoreTask ->
                            ...
                            binding.progressBar.visibility = View.GONE
                            binding.imageView.setImageResource(androidx.appcompat.resources.R.drawable.abc_vector_test)
                ...
                binding.imageView.setImageResource(com.google.android.material.R.drawable.abc_vector_test)
